...
Public Class InstallOptionsDlg
    ...
    Public Const cstrInstallerKey As String = "SOFTWARE\SIL\SilEncConverters40\Installer"
    Public Const cstrInstallFromDirKey As String = "MapsTablesPath"
...
#End If
        ...
        ' then we must quit.
        key = Registry.LocalMachine.OpenSubKey("SOFTWARE\SIL\SilEncConverters40")
        If (Not key Is Nothing) Then
            ...
            If (Not String.IsNullOrEmpty(sRootVal)) Then
                ...
                Dim keyInstaller As RegistryKey = Registry.LocalMachine.OpenSubKey(cstrInstallerKey)
                If (Not keyInstaller Is Nothing) Then
                    bShowTooltip = (keyInstaller.GetValue(cstrInstallShowToolbipKey, "True") = "True")
                    m_sSrcDir = keyInstaller.GetValue(cstrInstallFromDirKey) + "\"
                End If
